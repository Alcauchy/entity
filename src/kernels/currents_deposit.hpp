  ...
  public:
    ...
    Inline auto operator()(index_t p) const -> void {
      ...
      //   if constexpr (D == Dim::_2D) {
          ...
          //       i2_prev(p) + N_GHOSTS + 1,
          //       cur::jx1) += ONE;
          // J_acc(i1(p) + N_GHOSTS, i2(p) + N_GHOSTS, cur::jx1) += ONE;
          // J_acc(i1(p) + N_GHOSTS, i2(p) + N_GHOSTS + 1, cur::jx1) += ONE;
          ...
          //       i2_prev(p) + N_GHOSTS,
          //       cur::jx2) += ONE;
          // J_acc(i1(p) + N_GHOSTS, i2(p) + N_GHOSTS, cur::jx2) += ONE;
          // J_acc(i1(p) + N_GHOSTS + 1, i2(p) + N_GHOSTS, cur::jx2) += ONE;
